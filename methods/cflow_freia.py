"""
CFLOW Decoder Architecture — exact copy from gudovskiy/cflow-ad.

Source files:
  - model.py  → positionalencoding2d, subnet_fc, freia_*_head, load_decoder_arch, activation
  - utils.py  → _GCONST_, get_logp
"""
import math
import torch
...
# Original uses forward hooks; we fill it via TimmActivationEncoder wrapper.
activation = {}
